...
const ResumeWorkExperience = ({ work }: CProps) => {
  return (
    <div className="mt-4 mb-8">
      <h3 className="text-white font-semibold mt-2 tracking-wide lg:text-xl ">{work.company} -- <span className="text-white/75 text-sm font-normal">{work.position}</span></h3>
